...
#Run your data combining function
combined_results2 <- combine(results3, results4)
combined_county2 <- combined_results2$county2
combined_noncounty2 <- combined_results2$noncounty2

#Run your data combining function
combined_results3 <- combine(results5, results6)
combined_county3 <- combined_results3$county3
combined_noncounty3 <- combined_results3$noncounty3

plot.county(combined_county, State = "CA", top_bottom = "top", num_counties = 15)
plot.county(combined_county, State = "TX", top_bottom = "top", num_counties = 4)
plot.county(combined_county)
plot.county(combined_county, State = "NY", top_bottom = "top", num_counties = 10)
